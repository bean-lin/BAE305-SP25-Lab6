...
void loop()
{
  if (Serial.available() > 0)                         //if the user has sent a command to the RedBoard
  {
    ...
    {
      rightMotor(200/iSpeed);                                //drive the right wheel forward
      leftMotor(200/iSpeed);                                 //drive the left wheel forward
      delay(driveTime * distance.toInt() * iSpeed);            //drive the motors long enough travel the entered distance
    ...
    {
      rightMotor(-200/iSpeed);                               //drive the right wheel forward
      leftMotor(255/iSpeed);                                 //drive the left wheel forward
      delay(turnTime * distance.toInt() * iSpeed);             //drive the motors long enough turn the entered distance
      rightMotor(0);                                  //turn the right motor off
      leftMotor(0);                                   //turn the left motor off
    }
    else if (botDirection == "l")                   //if the entered direction is left
    {
      rightMotor(255/iSpeed);                                //drive the right wheel forward
      leftMotor(-200/iSpeed);                                //drive the left wheel forward
      delay(turnTime * distance.toInt() * iSpeed);             //drive the motors long enough turn the entered distance
      rightMotor(0);                                  //turn the right motor off
      leftMotor(0);                                   //turn the left motor off
